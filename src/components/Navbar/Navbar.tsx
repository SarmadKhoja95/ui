    ...
    return (
      <>
        ...
        <Menu.Item
          ...
          href="http://builder.manialands.com"
        >
          {i18n.menu.builder}
        </Menu.Item>
        <Menu.Item
          active={activePage === 'docs'}
          href="http://www.manialands.com/docs"
        >
          {i18n.menu.docs}
        </Menu.Item>
        <Menu.Item
          active={activePage === 'events'}
          href="http://www.manialands.com/event"
        >
          {i18n.menu.events}
        </Menu.Item>
        <Menu.Item
          active={activePage === 'dao'}
          href="http://www.manialands.com/dao"
        >
          {i18n.menu.dao}
        </Menu.Item>
        <Menu.Item
          active={activePage === 'blog'}
          href="http://www.manialands.com/blog"
        >
          {i18n.menu.blog}
        </Menu.Item>
      </>
          ...
          <div className="dcl navbar-menu">
            <NotMobile>
              <Menu secondary stackable>
                <a className="dcl navbar-logo" href="http://www.manialands.com">
                  <Logo />
                </a>
                {this.renderLeftMenu()}
              </Menu>
